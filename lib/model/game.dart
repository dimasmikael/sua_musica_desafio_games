...
class GameModel  extends ChangeNotifier{
 ...
 GameModel({this.id,
  //  this.cover, this.createdAt, this.firstRelease, this.modes, this.genres, this.keywords, this.platforms, this.perspectives, this.popularity, this.screenshots, this.summary, this.videos, this.rating, this.name
 } );
