...
//final List<ScreenshotModel>? screenshots;
 ...
 GameModel({this.id,
    // this.cover,
     this.createdAt, this.firstRelease,
   //  this.modes, this.genres, this.keywords,
    // this.platforms,
    // this.perspectives,
     this.popularity,
   // this.screenshots,
 ...
 GameModel.fromJson(Map<String, dynamic> json, )
  ...
  //  modes = json["game_modes"] == null ? null : (json["game_modes"] as List).map((i) => new ModeModel.fromJson(i)).toList(),
    ...
    //  keywords =  json["keywords"] == null ? null : (json["keywords"] as List).map((i) => new KeywordModel.fromJson(i)).toList(),
     // platforms = json["platforms"] == null ? null : (json["platforms"] as List).map((i) => PlatformModel.fromJson(i)).toList(),
  ...
  //  screenshots = json["screenshots"] == null ? null : (json["screenshots"] as List).map((i) => ScreenshotModel.fromJson(i)).toList(),
